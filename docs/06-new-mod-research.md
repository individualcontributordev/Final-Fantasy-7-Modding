...
3. **One Windows RE task** — chat steps + `docs/INSTRUCTIONS.md` COPY-PASTE/EVIDENCE (see `.agents/rules/mac-human-workflow.mdc`).
...
| Mac↔Windows RE loop via `INSTRUCTIONS.md` | 2026-07 | `.agents/rules/mac-human-workflow.mdc` |
