...
3. **One RE task** — chat steps + `docs/INSTRUCTIONS.md` COPY-PASTE/EVIDENCE (see `.agents/rules/agent-human-workflow.mdc`).
...
| Agent↔human RE loop via `INSTRUCTIONS.md` | 2026-07 | `.agents/rules/agent-human-workflow.mdc` |
