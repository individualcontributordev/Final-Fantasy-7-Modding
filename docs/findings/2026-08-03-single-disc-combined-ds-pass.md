# Finding: Single-disc combined Ask + SNOVA D1 DuckStation PASS
...
- workspace/iso-extract/ff7_d1_single_disc_work.bin
...
3. Once: python3 mods/single-disc/scripts/inject_snova_d3_to_d1.py --d1 WORK --d3 D3 --in-place
4. Expect: raw-copy + BATTLE.X LBA patch v3; 17 LBA entries remapped

## Next

Document recipe in mods/single-disc; CSR movie whitelist; later pack/console.
