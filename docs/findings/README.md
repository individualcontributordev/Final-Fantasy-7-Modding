...
|------|------|---------|------------|
| 2026-08-09 | [fanfare-skip-duckstation-compare](2026-08-09-fanfare-skip-duckstation-compare.md) | 800D3098 is per-frame GTE loop (not pose); next F83C6 write | in-progress |
