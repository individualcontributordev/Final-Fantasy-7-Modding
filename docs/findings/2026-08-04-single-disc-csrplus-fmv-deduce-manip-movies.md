...
to build the CSR-alone single-disc manip-movie whitelist (D2/D3 files to put on D1).
...
- 2026-08-04-single-disc-csr-manip-movies-pack-split.md (deferred pack)
- 2026-08-04-single-disc-ship-csrplus-highwind-first.md
- mods/single-disc/patches/field-movie-d2d3-missing-on-d1.md
