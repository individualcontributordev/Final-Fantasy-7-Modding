# Finding: Loading a save asks for disc 2 on no-disc-swap D1 pack
...
Burned no-disc-swap 0.1.0 Clean D1: on **load save**, game asks for disc 2.
...
| Fix | Notes |
|-----|--------|
| Document only | Ship as "D1 saves only" for Clean no-disc-swap |
