# Single-disc — blackbgb Ask skip prototype (pristine D1)

**Date:** 2026-08-02
**Confidence:** confirmed (script paste after Makou edit)
**Working image (operator):** `workspace/iso-extract/ff7_d1_single_disc_re.bin`
  (Windows path: `D:\projects\Final-Fantasy-7-Modding\workspace\iso-extract\ff7_d1_single_disc_re.bin`)
