# Finding: Ship single-disc for CSR+ and Highwind first; defer CSR base
...
Implement and publish single-disc first for:
...
| Config | Base | Add-ons |
|--------|------|---------|
| CSR+ single disc | CSR | CSR+ scene packs + single-disc-on-csr |
| Highwind single disc | Highwind | single-disc-on-highwind |

No manip-movies pack in this phase.

## Later

CSR base + single-disc-on-csr + single-disc-csr-manip-movies (tight whitelist under ~90 MB raw).

## Related

- 2026-08-04-single-disc-bases-csr-highwind-only.md
