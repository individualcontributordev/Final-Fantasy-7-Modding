# Single-disc RE — pristine D1 disc identity + field disc-change
...
How Unmodified Disc 1 encodes disc id and requests other discs. Baseline for an any-base single-disc add-on.
...
So a single-disc pack must at least:
