# Audit: no-disc-swap-clean-v0.1.1 vs pristine Clean D1

Question: Did Set next movie / Play movie (and Ask) deletes remove anything unintended?

Built: workspace/iso-extract/ff7_d1_clean_noswap_v011_built.bin
Layer: builder/no-disc-swap-clean-v0.1.1
