...
Lure/Away materia still scale `g_enemy_lure`. Builder add-ons use `exclusiveGroup: field-encounter-rate`.
...
- Reference: [docs/01-encounter-system.md](../../../docs/01-encounter-system.md)
