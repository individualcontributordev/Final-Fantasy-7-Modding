...
Does NOT start disc UI / fade (skips that path entirely).
  ...
  python3 mods/single-disc/scripts/stub_field_movie_dskcg.py \\
    --disc-image workspace/iso-extract/ff7_d1_single_disc_work.bin --in-place
"""
